...
<section class="relative py-24">
	<div class="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
		...
		<div class="mx-auto max-w-2xl border border-border/50 bg-card/80 backdrop-blur-sm">
			<div class="flex items-center gap-2 border-b border-border/50 bg-secondary/50 px-3 py-2 text-sm">
			...
			<div class="p-8">
				<h2 class="mb-4 text-3xl font-bold">
					<span class="text-[var(--term-green)]">Ready to</span> build something great?
				</h2>
				...
				<a
					href="/contact"
					class="group inline-flex items-center gap-2 border-2 border-[var(--term-green)] px-8 py-4 font-medium text-[var(--term-green)] transition-all hover:bg-[var(--term-green)] hover:text-[var(--term-bg)]"
				>
